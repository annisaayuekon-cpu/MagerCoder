...
# -------------------------------------------------
# Controls atas: pilih indikator & tahun (untuk peta & ranking)
# -------------------------------------------------
...
def render_colored_card(col, title, emoji, long_df, country, year):
    colors = {
        "GDP growth (%)": "#ffe8d6",
...
# -------------------------------------------------
# Mini trend row (tetap agregat global)
# -------------------------------------------------
